        ...
        <div class="card border-0 shadow h-100">
          <div class="card-body">
            <p class="card-text">
              快速测评辅助系统
              方案概述：
              针对等级保护测评机构进行研发出“快速测评辅助系统”，生成测评报告方便快捷。
              方案特点：
              1、可同时满足编制符合网络安全等级保护测评、商用密码应用性评估、风险评估相关国家、 行业相关标准要求的报告， 
              2、工具可满足采用 B/S 或 C/S 架构部署，并支持分布式部署方式。 
              3、支持用户使用密码技术和口令的双因素身份认证方式登录测评工具，支持用户分级管理和 权限控制方式。
              4、支持多种数据导入方式。
              5、以加密方式传输和存储测评记录。
        ...
        <div class="card border-0 shadow h-100">
          <div class="card-body">
            <p class="card-text">
              商用密码应用与检测工具箱
              方案概述：
              为了给商用密码行业下相关安全系统开发设计测试工程师、商用密码检测工程师、密码初学者提升工作效率，艾拉科技研发出商用密码应用与检测工具箱，目前是               国内仅有的一款包含大量的国外密码算法实现，以及全部国内密码算法的应用软件，而且仍在不停地有新的算法添加进去。
              方案特点：
              1、密码应用（基础算法、应用场景、周边功能、客户端模拟器）。
              2、流量分析（流量导入、分析插件、展示插件、关联分析）。
        ...
        <div class="card border-0 shadow h-100">
          <div class="card-body">
            <p class="card-text">
              新渡-国密安全WEB网关
              方案概述：
              满足国家标准《GBT 38636-2020 信息安全技术 传输层密码协议（TLCP）》情况下，艾拉科技研发 "新渡-国密安全WEB网关（GMSWG）”产品，此产品是通               过国密算法和国际算法实现，支持与WEB应用建立国密安全网络连接或国际安全网络连接的网关产品。
              方案特点：
              1、多方面的安全保护机制。
              2、多网站保护。
              3、国际国密访问自适应。
              ...
              方案优势：
              1、既支持国密访问又支持国际访问。
              2、采用Keepalived高可用架构， 故障时秒级切换，保证会话不中断，业务无感知。
              3、支持配置负载均衡策略，从而增加服务器的吞吐量，保障网络数据的处理能力、提高网络的灵活性和可用性。
              4、全面支持Windows、MAC、Linux等主流操作系统及主流浏览器接入，同时支持应用单点登录等功能。
